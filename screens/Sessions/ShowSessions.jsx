...
const ShowSessions = ({ route }) => {
  ...
  const weightBefore = sessionDetails.weight_before ?? sessionDetails.weightBefore ?? '--';
  const weightAfter = sessionDetails.weight_after ?? sessionDetails.weightAfter ?? '--';
  const fluidRemoved = sessionDetails.fluid_removed ?? sessionDetails.fluidRemoved ?? '--';
  const bloodPressureBefore =
    sessionDetails.blood_pressure_before ?? sessionDetails.bloodPressureBefore ?? '--';
  const bloodPressureAfter =
    sessionDetails.blood_pressure_after ?? sessionDetails.bloodPressureAfter ?? '--';
