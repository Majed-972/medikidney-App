...
const NurseTasks = ({ route, navigation }) => {
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      await api.post('/dialysis-sessions', finalPayload);
          ...
          <View style={[styles.card, { borderColor: '#26CDD6' }]}>
                  ...
                  style={[
                    ...
                    status === st &&
                      (st === 'COMPLETED'
                        ...
                        : st === 'CANCELLED'
                          ? styles.statusBtnActiveRed
                          : styles.statusBtnActiveOrange),
                  ]}
            ...
            >
              {loading ? (
                ...
                <Text style={styles.buttonText}>إرسال التقرير</Text>
              )}
            </TouchableOpacity>
