    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.description}>
          تطبيق <Text style={styles.boldText}>MediKidney</Text> هو مشروع تخرج مبتكر يهدف إلى رقمنة
          وتحسين إدارة متابعة مرضى غسيل الكلى داخل المستشفيات.
        </Text>

        <Text style={styles.description}>
          يوفر النظام منصة متكاملة تربط المريض، والممرض، وأخصائي التغذية لضمان مراقبة الحالة الصحية
          بشكل دقيق ومنظم وآمن تماماً.
        </Text>
      </View>
