  ...
  useEffect(() => {
    const fetchPatient = async () => {
      try {
        ...
        const endpoint = patientId ? `/users/profile/patients/${patientId}` : `/users/profile`;
    ...
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.header, { transform: [{ scaleY: headerHeight }] }]}>
        ...
        <View style={styles.quickStats}>
          ...
          <View style={styles.qDivider} />
          <View style={styles.qStat}>
            <Text style={styles.qStatVal} numberOfLines={1}>
              {patient.national_id || '—'}
            </Text>
      ...
      >
        <SectionCard
          title={t.patientInfo.personalData}
        ...
        >
          ...
          />
          <InfoRow
            label={t.patientInfo.nationalId}
        ...
        <SectionCard
          title={t.patientInfo.contactInfo}
          icon="phone-outline"
          accentColor="#26CDD6"
          defaultOpen={true}
        >
          <InfoRow
            ...
            value={patient.phone_number || patient.phone}
            icon="phone"
            color="#26CDD6"
          />
          <InfoRow
            label={t.patientInfo.emergencyPhone}
        ...
        <SectionCard
          title={t.patientInfo.medicalHistory}
          icon="medical-bag"
          accentColor="#DE1A1C"
          defaultOpen={true}
        >
          <InfoRow
            label={t.patientInfo.bloodType}
            value={patient.blood_type}
            icon="water-plus"
            color="#DE1A1C"
          />
          <InfoRow
            label={t.patientInfo.chronicDiseases}
            value={patient.chronic_diseases}
            icon="heart-pulse"
            color="#A32D2F"
          />
          <InfoRow
            label={t.patientInfo.allergies}
            value={patient.allergies}
            icon="allergy"
            color="#A32D2F"
          />
          <InfoRow
            label={t.patientInfo.medicalNotes}
            value={patient.medical_history_notes}
            icon="file-document-outline"
            color="#8296B1"
          />
          <InfoRow
            label={t.patientInfo.generalNotes}
            value={patient.notes}
          ...
          <View style={styles.infoRow}>
            <View
              style={[
                styles.infoIconBox,
                { backgroundColor: (isSmoker ? '#DE1A1C' : '#26CDD6') + '18' },
              ]}
            >
              <Icon
                name="smoking"
